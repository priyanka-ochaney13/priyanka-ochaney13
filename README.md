...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=C8680A&center=true&vCenter=true&width=600&lines=Hey%2C+I'm+Priyanka+%F0%9F%91%8B;Backend+Developer+%7C+Systems+Thinker;Building+things+that+actually+work." alt="Typing SVG" />
...
```json
{
  ...
  "stack"    : ["Python", "Java", "FastAPI", "Spring Boot", "AWS"],
  "gives_up" : false
}
```
